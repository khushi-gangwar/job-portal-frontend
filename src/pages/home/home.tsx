...
const Home = () => {
  return (
    <div>
      <Navbar />
      <div className="flex flex-col lg:flex-row bg-cover bg-center px-12 lg:px-20 py-16 gap-10">
        {/* Left Section */}
        <div className="flex flex-col items-center justify-center text-center relative w-full lg:w-1/2 px-4">
          ...
          <h1 className="text-6xl sm:text-5xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-300 z-10">
            Welcome to DevSpot
          </h1>
          <p className="text-gray-600 mt-4 text-3xl sm:text-xl max-w-xl">
